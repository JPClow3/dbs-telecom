...
export interface AuthUserPayload {
  ...
  role?: 'client' | 'admin';
  /**
   * Versão de sessão no momento da emissão. Emitida por user.service
   * (getTokenVersion) e validada por isTokenSessionValid; incrementada a cada
   * troca de senha para revogar tokens anteriores.
   */
