...
- Todas as sessões e o histórico de mensagens são persistidos no banco de dados **SQLite**, mantendo o histórico de conversas intacto mesmo após reinicialização do servidor.
    `,
    contact: {
  ...
  paths: {
          ...
          content: {
            'application/json': {
              schema: {
                ...
                required: ['cpfCnpj'],
                properties: {
                  cpfCnpj: { type: 'string', example: '154.293.707-89' },
                },
              },
            },
          },
    ...
    '/chat/message': {
      post: {
        ...
        description: 'Processa a mensagem em linguagem natural, roteando para Comercial, Suporte ou Financeiro, persistindo no SQLite.',
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
    ...
    '/chat/history/{sessionId}': {
      get: {
        tags: ['💬 Atendimento Inteligente & Chatbot IA'],
        summary: 'Recupera o histórico completo de mensagens persistidas em SQLite',
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: 'sessionId',
        ...
        responses: {
          '200': {
            description: 'Histórico de mensagens recuperado do SQLite',
            content: {
              'application/json': {
                schema: {
                  type: 'object',
  ...
  components: {
    ...
    schemas: {
        ...
        properties: {
          ...
          ai: {
            ...
            properties: {
              ...
              geminiModel: { type: 'string', example: 'gemini-flash-lite-latest' },
      ...
      LoginRequest: {
        ...
        required: ['cpfCnpj'],
        properties: {
          cpfCnpj: { type: 'string', example: '154.293.707-89', description: 'CPF ou CNPJ do cliente cadastrado no IXC' },
          password: { type: 'string', example: '15429370789', description: 'Senha de acesso (Padrão: CPF sem pontos)' },
        },
      },
      LoginResponse: {
        type: 'object',
      ...
      Customer: {
        ...
        properties: {
          ...
          nome: { type: 'string', example: 'Emanuel da Silva' },
          fantasia: { type: 'string', example: 'Emanuel Silva' },
          cpfCnpj: { type: 'string', example: '154.293.707-89' },
          email: { type: 'string', example: 'emanuel.silva@dbstelecom.com.br' },
      ...
      ChatMessage: {
        ...
        properties: {
          ...
          text: { type: 'string', example: 'Olá, Emanuel! Localizei sua fatura...' },
          timestamp: { type: 'string', example: '2026-08-20T00:00:00.000Z' },
          ...
          aiModel: { type: 'string', example: 'gemini-flash-lite-latest' },
